...
public:
    ...
    typedef enum LINKTYPE{
        CLOCK_WISE = 50,
        INTERSECTION = 100,
        COUNTER_CLOCK_WISE = 150,
        SLOPE = 1000
        // CLOCK_WISE_TERNEL_1 = 70,
        // CLOCK_WISE_TERNEL_2 = 30,
        // COUNTER_CLOCK_WISE_TERNEL_1 = 170,
        // COUNTER_CLOCK_WISE_TERNEL_2 = 130
    } LINKTYPE;
